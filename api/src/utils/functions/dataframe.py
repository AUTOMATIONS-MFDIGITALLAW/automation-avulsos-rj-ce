...
class DataFrameUtils:
    ...
    def data_frame(file_path: str, colunas_esperadas=None):
        ...
        if colunas_esperadas is None:
            colunas_esperadas = ["DATA RECEBIMENTO BCC AVULSO","HORA RECEBIMENTO BCC AVULSO", "PROCESSO", "AUDIÊNCIA?", "DATA AUDIÊNCIA", "HORA AUDIÊNCIA", "DATA CITAÇÃO", "HORA CITAÇÃO", "DILIGÊNCIA", "DESCRIÇÃO"]
